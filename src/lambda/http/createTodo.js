...
var bucketName = process.env.TODOS_FILEBUCKET;
var s3 = new AWS.S3({
    signatureVersion: 'v4'
});
var dateTimestamp = Date.now();
exports.handler = function (event) { return __awaiter(_this, void 0, void 0, function () {
    var parsedToDo, itemid, newToDo, url;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log('adding to do list ', event.body);
                parsedToDo = JSON.parse(event.body);
                itemid = uuid.v4();
                newToDo = __assign({ todoId: itemid, createdAt: dateTimestamp.toString() }, parsedToDo);
                return [4 /*yield*/, todoClient.put({
                        TableName: todotablename,
                        Item: newToDo
                    }).promise()];
            case 1:
                _a.sent();
                url = getUploadUrl(itemid);
                return [2 /*return*/, {
                        statusCode: 201,
                        headers: {
